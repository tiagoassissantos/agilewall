...
$.extend($.validator, {
	...
	messages: {
		...
		creditcard: "Por favor, forneça um número de cartão de crédito válido.",
		equalTo: "Por favor, forneça o mesmo valor novamente.",
		accept: "Por favor, forneça um valor com uma extenção válida.",
		maxlength: $.validator.format("Por favor, forneça não mais do que {0} caracteres."),
		minlength: $.validator.format("Por favor, forneça não menos do que {0} caracteres."),
