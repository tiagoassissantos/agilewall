...
Papel.create! :nome => 'DP', :descricao => 'Criador e Dono do Projeto'
Papel.create! :nome => 'GP', :descricao => 'Gerente do Projeto'
Papel.create! :nome => 'PO', :descricao => 'Dono do Produto (Cliente)'
Papel.create! :nome => 'DV', :descricao => 'Desenvolvedor Membro da Equipe'
Papel.create! :nome => 'TT', :descricao => 'Testador'